...
type Stream = Base & (StreamBegin | StreamMiddle | StreamEnd) & { type: "stream" }

type Info = Path | Stream | Town | PathClearing

let current: Info | undefined = {
    name: "Woesong Bridge",
    proximity: 100,
    through: {
        area: "middle",
