...
var Animal19 = function () {
    var _a;
    var _instanceExtraInitializers = [];
    var _greet_decorators;
    return _a = /** @class */ (function () {
            function Animal19(type) {
                this.type = __runInitializers(this, _instanceExtraInitializers);
                this.type = type;
            }
            Animal19.prototype.greet = function () {
                console.log("Hello, I'm a(n) ".concat(this.type, "!"));
            };
            return Animal19;
        }()),
        (function () {
...
var typeToYellingMap = {
    cat: 'meow~ meow~'
};
function yelling(originalMethod, context) {
    return function () {
        var args = [];
